  # 1.98.5
  - Update tailscale to 1.98.5

  # 1.98.3
  - Update tailscale to 1.98.3

  # 1.98.2
  - Update tailscale to 1.98.2

  # 1.96.4
  - Update tailscale to 1.96.4

  # 1.96.3
  - Update tailscale to 1.96.3

  # 1.96.2
  - Update tailscale to 1.96.2

  # 1.94.2
  - Update tailscale to 1.94.2

  # 1.94.1
  - Update tailscale to 1.94.1

  # 1.92.5
  - Update tailscale to 1.92.5

  # 1.92.3
  - Update tailscale to 1.92.3

  # 1.92.2
  - Update tailscale to 1.92.2

  # 1.90.9
  - Update tailscale to 1.90.9

  # 1.90.8
  - Update tailscale to 1.90.8

  # 1.90.6
  - Update tailscale to 1.90.6

  # 1.90.4
  - Update tailscale to 1.90.4

  # 1.90.3
  - Update tailscale to 1.90.3

  # 1.90.2
  - Update tailscale to 1.90.2

  # 1.90.1
  - Update tailscale to 1.90.1

  # 1.88.3
  - Update tailscale to 1.88.3

  # 1.88.1
  - Update tailscale to 1.88.1
